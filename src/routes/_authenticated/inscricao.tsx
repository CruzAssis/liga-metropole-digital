  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (team) {
        await supabase
          .from('profiles')
          .update({ time_diretor_id: team.id })
          .eq('id', user.id)
      }
      ...
      <div className="max-w-lg mx-auto space-y-8">
        ...
        <div className="bg-zinc-900 border border-[#1565F5]/30 rounded-lg p-4">
          <p className="text-sm text-zinc-300">
            ...
            {' '} garanta sua vaga. Apos aprovacao, voce recebe instrucoes de pagamento via WhatsApp.
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="cor_primaria" className="text-zinc-300">Cor primaria</Label>
              <div className="flex items-center gap-2 mt-1">
                <input type="color" id="cor_primaria" name="cor_primaria" value={form.cor_primaria} onChange={handleChange} className="h-10 w-12 rounded cursor-pointer bg-transparent border-0" />
            ...
            <div>
              <Label htmlFor="cor_secundaria" className="text-zinc-300">Cor secundaria</Label>
              <div className="flex items-center gap-2 mt-1">
                <input type="color" id="cor_secundaria" name="cor_secundaria" value={form.cor_secundaria} onChange={handleChange} className="h-10 w-12 rounded cursor-pointer bg-transparent border-0" />
