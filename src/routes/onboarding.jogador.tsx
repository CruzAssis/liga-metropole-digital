  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const { error } = await supabase.from('athletes').insert({
        ...
        cpf_hash, cpf_last4, team_id: mode === 'team' && selectedTeamId ? selectedTeamId : null, verified: false,
      })
      ...
      <div className="max-w-xl mx-auto space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="flex justify-between text-xs text-zinc-600 mt-1"><span>Iniciante (1)</span><span>Craque (10)</span></div>
          </div>
