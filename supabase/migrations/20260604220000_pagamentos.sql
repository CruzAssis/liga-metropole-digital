...
CREATE TABLE IF NOT EXISTS public.pagamentos (
  ...
  mes_referencia   date NOT NULL,  -- primeiro dia do mês (ex: 2026-06-01)
...
-- Admins podem tudo (via service_role / admin check via profiles)
...
-- (atrasado = pendente há mais de 30 dias após mes_referencia)
